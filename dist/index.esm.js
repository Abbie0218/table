...
var Delete = createSvgIcon( /*#__PURE__*/jsxRuntimeExports.jsx("path", {
  d: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6zM19 4h-3.5l-1-1h-5l-1 1H5v2h14z"
}), 'Delete');

var CommonTable = function (_a) {
    var columns = _a.columns, data = _a.data, onRowDelete = _a.onRowDelete, styles = _a.styles;
    return (React.createElement(Table$1, null,
        React.createElement(TableHead$1, null,
            React.createElement(TableRow$1, { sx: { background: styles.headerBgColor } },
                React.createElement(TableCell$1, { padding: "checkbox" },
                    React.createElement(Checkbox$1, { color: "primary" })),
                columns.map(function (column) { return (React.createElement(TableCell$1, { key: column.id, sx: { color: styles.headerTxtColor } }, column.label)); }),
                React.createElement(TableCell$1, { sx: { color: styles.headerTxtColor } }, "Actions"))),
        React.createElement(TableBody$1, null, data.map(function (row, rowIndex) {
            debugger;
            return (React.createElement(TableRow$1, { key: rowIndex, sx: { '&:hover': { backgroundColor: styles.hoverRowBgColor } } },
                React.createElement(TableCell$1, { padding: "checkbox" },
                    React.createElement(Checkbox$1, { color: "primary" })),
                columns.map(function (column) {
                    debugger;
                    return (React.createElement(TableCell$1, { key: column.id }, row[column.id]));
                }),
                React.createElement(TableCell$1, null,
                    React.createElement(IconButton$1, { onClick: function () { return onRowDelete(rowIndex); }, color: "error" },
                        React.createElement(Delete, null)))));
        }))));
};

export { CommonTable as Table };
